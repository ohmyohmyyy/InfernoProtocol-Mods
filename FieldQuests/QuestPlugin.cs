...
[BepInPlugin("com.holden.infernoprotocol.fieldquests", "ContentPlus", "0.5.0")]
public sealed class QuestPlugin : BasePlugin
{
    ...
    public override void Load()
    {
        ...
        Log.LogInfo("ContentPlus 0.5.0 loaded. Quest board, XP progression and equipment finishes. Use Interact to read the board (F9 also works).");
    }
